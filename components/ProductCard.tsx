  ...
  return (
    <div className="flex flex-col h-[277px] justify-center items-center border-r shadow-md w-[210px]">
      ...
      {availability}
        ...
        <p className="text-[#8D7A6B]"> 
        ❶ 
        </p>
      </div>
      
        </div>
      <div className="text-sm text-center items-center justify-center bg-[#A3D9A5] h-[40px] leading-normal w-full">
        <p className="font-manrope text-sm font-semibold leading-[20.49px] hover:text-white p-2 text-[#FBF6F1]">Add to Cart</p>
      </div>
    </div>
  );
};
