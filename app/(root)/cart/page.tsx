              ...
              {cartItems.map((item) => (
                <tr key={item.id} className="border-b">
                  <td className="px-6 py-4 items-center flex max-sm:flex-col">
                    ...
                    />
                    <div>
                      <p className="font-manrope sm:text-[20px] text-xs font-bold sm:leading-[27.32px] text-left text-[#8D7A6B]">{item.name}</p>
                      <p className="text-[#D4A373]">⭐⭐⭐⭐☆</p>
                      <p className="font-manrope sm:text-[12px] text-xs sm:leading-[27.32px] mt-5 text-left text-[#A3D9A5]">In Stock: {item.inStock}</p>
                    </div>
                  </td>
